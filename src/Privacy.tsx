        ...
        <SimpleAnimation
          ...
          <Card
            ...
            <Text style={styles.text}>
              ...
              referred to as “Services”. Your use of the Services indicates you agree to this policy
              and our
              <Text status={'primary'} onPress={() => navigation.navigate('Terms')}> terms of use</Text>.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              or device. Aggregate data isn’t considered Personal Info.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              doesn’t collect your IP address. We do detect non-personally identifiable geo-location
              information to optimize our services, but we definitely don't collect your precise
              geo-location or associate geo-location information with a particular user.
            </Text>
            <Text style={styles.text}>
              Because we do not collect information about your online activities over time and
              across third-party websites or online services, there is no need for us to respond to
              a browser’s Do Not Track settings, although we strongly support a consumer’s right to
              set such a preference and encourage all website operators to honor this consumer
              choice.
            </Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.textHeader} category={'h6'}>
              2. TomHibbers never sells your email address or any other Personal Info you volunteer
            </Text>
            <Text style={styles.text}>
              We don’t receive payment in cash or in kind from third parties in exchange for your
              Personal Info. Further, we don’t allow third parties to collect info about you on our
              site through cookies or other means.
            </Text>
            <Text style={styles.textHeader} category={'h6'}>
            ...
            <Text style={styles.text}>
              ...
              contracts with users or third parties, or to prevent harm to others and their property
            ...
            <Text style={styles.text}>
              ...
              it, but we require valid legal process to compel the disclosure of user data to the
              government; such as a legitimate and properly scoped court order, or a search warrant
              supported by probable cause and issued by an appropriate law enforcement authority. We
              interpret requests narrowly, and we will oppose unlawful or overbroad requests for
              specific user data.
            </Text>
            <Text style={styles.text}>
            ...
            <Text style={styles.text}>
              ...
              you, so you’re encouraged to review the policy from time to time. Substantive changes
              to this policy will be emailed to users who submit a request to
              <Text
                status={'primary'}

        ...
        <ScrollView
          ...
          <SimpleAnimation
            ...
            <Card
              ...
              <Text style={styles.text}>
                Access to some of our Services requires you to download a software package —
                referred to as “Software”. The Software is licensed to you and not sold, subject to
                the terms of this agreement. We grant you a nonexclusive, nontransferable, revocable
              ...
              <Text style={styles.text}>
                ...
                written agreements. There may be provisions in the open-source licenses that
                expressly override these terms.
              </Text>
              <Text style={styles.textHeader} category={'h5'}>
                Protected property
              </Text>
              ...
              <Text style={styles.text}>
                ...
                our blog or forum — so please be careful with what you post.
              </Text>
              <Text style={styles.textHeader} category={'h5'}>
              ...
              <Text style={styles.text}>
                ...
                responsible for the practices employed by websites linked to or from the Services,
                nor their information or content. When you use a link to go from the Services to
                another website, your browsing and interaction is subject to that website's own
                rules and policies, not ours. Please read over those rules and policies before
                proceeding.
              </Text>
              <Text style={styles.textHeader} category={'h5'}>
                Support
              ...
              <Text style={styles.text}>
                ...
                support or maintenance for the Services under this agreement. However, we may, at
                our sole discretion, provide limited technical support, upgrades, and updates.
              </Text>
              <Text style={styles.textHeader} category={'h5'}>
                Termination
              </Text>
              <Text style={styles.text}>
                ...
                the Services. We may terminate this agreement and your use at any time, without
                cause and without notice. This agreement will automatically terminate if you fail to
                comply with the Terms. Upon any termination, you agree to uninstall and stop using
                the Services.
              </Text>
              <Text style={styles.textHeader} category={'h5'}>
                No warranty

        ...
        <SimpleAnimation
          ...
          <Card
            ...
            <Text style={styles.text}>
              Thank you for using TomHibbers. These terms of use — referred to as “Terms” — apply to
              your use of TomHibbers’s software and services (including the apps Tom Hibbers) — referred to as
              “Services”. Your use of the Services indicates you agree to the Terms, so please read
              carefully.
            </Text>
            ...
            <Text style={styles.text}>
              ...
              TomHibbers. We may update the Software on your device automatically to provide new
            ...
            <Text style={styles.text}>
              ...
              These terms don’t give you the right to use the TomHibbers logos, trademarks, domain
            ...
            <Text style={styles.text}>
              ...
              as part of the Services, you give TomHibbers the right to use such content. TomHibbers
              doesn’t control, monitor, or have any detailed knowledge of the content. Therefore,
              you may be exposed to info that’s incorrect, offensive, or otherwise objectionable.
              TomHibbers shall not be liable for the content and other info spread or delivered
              through or in connection with the Services. You agree that you shall bear all risks
              associated with the use of such info. We have no responsibility to remove content you
              make public — for example, comments you make on our blog or forum — so please be
              careful with what you post.
            </Text>
            <Text style={styles.textHeader} category={'h5'}>
            ...
            <Text style={styles.text}>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, TOMHIBBERS MAKES NO WARRANTY OR REPRESENTATION
              WITH RESPECT TO THE SERVICES, THEIR QUALITY, PERFORMANCE, MERCHANTABILITY, OR FITNESS
              FOR A PARTICULAR PURPOSE. AS A RESULT, THE SERVICES ARE PROVIDED “AS IS” AND YOU’RE
            ...
            <Text style={styles.text}>
              ...
              significant will be emailed to users who subscribe to the TomHibbers newsletter or to
